...
export const getCustomAttributes = (tag) => {
  ...
  return {
    ...
    checkboxPrefixMarker: getAttribute(tag, 'data-cli-checkbox-prefix-marker', null),
    checkboxPrefixColor: getAttribute(tag, 'data-cli-checkbox-prefix-color', null),
    checkboxSuffixMarker: getAttribute(tag, 'data-cli-checkbox-suffix-marker', null),
    checkboxSuffixColor: getAttribute(tag, 'data-cli-checkbox-suffix-color', null),
    // For input radio
    ...
    radioPrefixMarker: getAttribute(tag, 'data-cli-radio-prefix-marker', null),
    radioPrefixColor: getAttribute(tag, 'data-cli-radio-prefix-color', null),
    radioSuffixMarker: getAttribute(tag, 'data-cli-radio-suffix-marker', null),
    radioSuffixColor: getAttribute(tag, 'data-cli-radio-suffix-color', null),
    // For input button
    buttonPrefixMarker: getAttribute(tag, 'data-cli-button-prefix-marker', null),
    buttonPrefixColor: getAttribute(tag, 'data-cli-button-prefix-color', null),
    buttonSuffixMarker: getAttribute(tag, 'data-cli-button-suffix-marker', null),
    buttonSuffixColor: getAttribute(tag, 'data-cli-button-suffix-color', null),
    ...
    colorBracketColor: getAttribute(tag, 'data-cli-color-bracket-color', null),
    colorValueColor: getAttribute(tag, 'data-cli-color-value-color', null),
    showHex: getAttribute(tag, 'data-cli-show-hex', null),
    // For input password - new
    passwordChar: getAttribute(tag, 'data-cli-password-char', null),
    showLength: getAttribute(tag, 'data-cli-show-length', null),
    // For input email - new
    emailPrefix: getAttribute(tag, 'data-cli-email-prefix', null),
    emailPrefixColor: getAttribute(tag, 'data-cli-email-prefix-color', null),
    emailColor: getAttribute(tag, 'data-cli-email-color', null),
    // For input date - new
    datePrefix: getAttribute(tag, 'data-cli-date-prefix', null),
    datePrefixColor: getAttribute(tag, 'data-cli-date-prefix-color', null),
    dateColor: getAttribute(tag, 'data-cli-date-color', null),
    // For input file - new
