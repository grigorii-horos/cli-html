...
export const h4 = blockTag((value) => ` ${chalk.green.bold(`§ ${value}`)}`, {
  marginTop: 1,
  marginBottom: 1,
});
export const h5 = blockTag((value) => ` ${chalk.green(`§ ${value}`)}`, { marginTop: 1, marginBottom: 1 });
export const h6 = blockTag((value) => ` ${chalk.green.dim(`§ ${value}`)}`, {
  marginTop: 1,
  marginBottom: 1,
});
