...
export const samp = inlineTag((value) => chalk.grey(value));
export const kbd = inlineTag((value) => chalk.white.bgBlack(value));
export const variableTag = inlineTag((value) => chalk.green(value));
